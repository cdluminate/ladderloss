...
def crit():
    return ladderloss.LadderLoss(
            ...
            thresholds=[0.40],
            betas=[0.25],
            reldeg=sbert.F30kSbertSimMat(ladderloss.F30kCaption(), diagone=True))

if __name__ == '__main__':
    cprint('! Building cache for F30kSbertSimMat ...', 'red')
    reldeg = sbert.F30kSbertSimMat(ladderloss.F30kCaption())
    print(reldeg)
